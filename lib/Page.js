...
export default class Page extends EventEmitter {
    ...
    constructor(parent, options) {
        ...
        assert(_.isString(userAgent), "Page options.userAgent must be string");
        assert(_.isFinite(beginFrameTimeout), "Page options.beginFrameTimeout must be number");
        assert(_.isString(frameFormat), "Page options.frameFormat must be string");
        assert(_.isFinite(frameQuality), "Page options.frameQuality must be number");
