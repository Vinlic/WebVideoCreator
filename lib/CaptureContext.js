...
export default class CaptureContext {
    ...
    timeVirtualizationRewrite() {
        ...
        window.Date = (timestamp) => new Date(timestamp || Date.now());
        // 重写performance.now函数
    ...
    convertToVideoCanvas(e) {
        ...
        const options = {
            ...
            startTime: parseInt(e.getAttribute("start-time") || e.getAttribute("startTime")),
            endTime: parseInt(e.getAttribute("end-time") || e.getAttribute("endTime")),
            seekStart: parseInt(e.getAttribute("seek-start") || e.getAttribute("seekStart")) || (currentTimeAttribute ? parseInt(currentTimeAttribute) * 1000 : null),
