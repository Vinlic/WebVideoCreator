...
import { VIDEO_CODEC, AUDIO_CODEC } from "./const.js";
...
export default preset => {
    ...
    assert(_.isString(VIDEO_CODEC[A2][A3]), `video codec ${A2}_${A3} is not supported`);
    assert(_.isString(AUDIO_CODEC[A4]), `audio codec ${A4} is not supported`);
    ...
    return {
        ...
        videoCodec: VIDEO_CODEC[A2][A3],
        audioCodec: AUDIO_CODEC[A4],
