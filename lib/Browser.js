...
export default class Browser {
    ...
    executablePath;
    /** @type {boolean} - 是否使用GPU加速渲染 */
    useGPU = false;
    /** @type {boolean} - 3D渲染后端是否使用Angle，建议开启 */
    useAngle = true;
    /** @type {boolean} - 是否禁用共享内存，当/dev/shm较小时建议开启此选项 */
    disableDevShm = false;
    /** @type {string[]} - 浏览器启动参数 */
    args = [];
    /** @type {PageOptions} - 页面选项 */
    pageOptions = {};
    #launchCallbacks = [];
    #firstPage = true;
    closed = false;
    ...
    constructor(parent, options) {
        ...
        this.useGPU = _.defaultTo(useGPU, false);
