...
export default class Browser {
    ...
    constructor(parent, options) {
        ...
        assert(_.isBoolean(useGPU), "Browser useGPU must be boolean");
        assert(_.isBoolean(useAngle), "Browser useAngle must be boolean");
        assert(_.isBoolean(disableDevShm), "Browser disableDevShm must be boolean");
        assert(_.isArray(args), "Browser args must be array");
        assert(_.isBoolean(debug), "Browser debug must be boolean");
